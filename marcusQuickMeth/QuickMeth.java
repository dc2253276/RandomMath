...
import marcusQuickMeth.Meth;
import marcusQuickMeth.Constants;
import marcusQuickMeth.Error;
/**
 * @author marcus8448
 * Version 7.0.0
 */
public class QuickMeth {
	...
	/**
	 * Use the custom error messages see Error.InvalidNumber();
	 */
	@Deprecated
	...
	/**
	 * Info about the currently in use release of Quick Meth
	 */
	...
	public static void start() {
		int OpChooseI = 0;
		String OpChooseS = JOptionPane.showInputDialog(null, "Enter '1' to Multiply, '2' to Divide, '3' to Subtract, '4' to Add, '5' to end the program and '6' to see QuickMeth INFO.", "Enter a number from 1 - 6", 3);
		try {
